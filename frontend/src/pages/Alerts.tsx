...
import { AlertTriangle, ShieldAlert, Eye, Users, Filter, Search } from "lucide-react";
      ...
      <div className="rounded-2xl glass-panel p-5">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {["all", "intrusion", "loitering", "crowd"].map((t) => (
              <button
                key={t}
          ...
          <div className="space-y-2">
            {filtered.map((alert) => {
              ...
              return (
                <div
                  key={alert.id}
                  className="flex items-center gap-4 p-4 rounded-xl bg-ow-teal/8 border border-[rgba(255,255,255,0.04)]
                             hover:bg-ow-teal/15 hover:border-ow-accent/10 transition-all cursor-pointer"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm font-semibold capitalize text-ow-light/90">{alert.event_type}</span>
                    </div>
